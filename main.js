...
//     document.body.innerHTML += `<h3>company name: ${
//       objectArray[index].companyNAme
//     } city: ${objectArray[index].city} pictur: <img src=${
//       objectArray[index].pictureId
//     }> number id: ${(objectArray[index].id = index)} link: <a href=${
//       objectArray[index].link
//     }> click to website</a> `;
//     index++;
//   }
// }
...
//     document.body.innerHTML += `<h3>company name: ${
//       objectArray[index].companyNAme
//     } city: ${objectArray[index].city}
//       number id: ${(objectArray[index].id = index)} link: <a href=${
//       objectArray[index].link
//     }><img src=${objectArray[index].pictureId}></a> `;
//     index++;
//   }
// }
...
//   user2.name = nameId.value;
//   user2.password = pass.value;
//   user2.email = emailId.value;
//   user2.userNAme = userNameId.value;
...
// function chegIfAge18(objectArray) {
//   for (let i = 0; i < objectArray.length; i++) {
//     if (objectArray[i].age > 18) {
//       document.body.innerHTML += `<h3>${objectArray[i].name}</h3>`;
//     } else {
//       document.body.innerHTML += `<h3>${objectArray[i].lastNAme}</h3>`;
//     }
//   }
// }
// chegIfAge18(arrayObjectsUsers);
...
// const divCollection = document.querySelectorAll(".myDiv");
